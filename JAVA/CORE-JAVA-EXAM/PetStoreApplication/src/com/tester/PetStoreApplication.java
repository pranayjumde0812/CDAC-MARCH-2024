                ...
                try {
                    switch (choice) {
                        case 1:
                            ...
                            break;
                        case 2:
                            addNewPet(sc, petList, loggedInUser);
                            break;
                        case 3:
                            updatePetDetails(sc, petList, loggedInUser);
                            break;
                        case 4:
                            displayAllPets(petList);
                            break;
                        case 5:
                            orderPet(sc, petList, orderList);
                            break;
                        case 6:
                            checkOrderStatusById(orderList, sc);
                            break;
                        case 7:
                            updateOrderStatus(orderList, sc, loggedInUser);
                            break;
                        case 0:
